...
export const metadata = { title: "Gebruik op je telefoon — TimeSaverTools" };

const iphoneSteps = [
  { step: "1", text: "Open Safari op je iPhone (niet Chrome of een andere browser)." },
  { step: "2", text: "Ga naar timesavertools.nl en log in." },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white border-b border-gray-100 px-6 py-4 max-w-3xl mx-auto flex items-center justify-between">
        ...
        <Link href="/dashboard" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">&larr; Dashboard</Link>
      </nav>

      <main className="max-w-3xl mx-auto px-6 py-14">
        <h1 className="text-3xl font-extrabold text-gray-900 mb-3">Gebruik op je telefoon</h1>
        <p className="text-gray-500 text-lg mb-10">
          Voeg TimeSaverTools toe aan je beginscherm &mdash; dan heb je het altijd binnen handbereik, net als een echte app.
        </p>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8">
            ...
            <div className="mt-6 bg-blue-50 rounded-xl px-5 py-3 text-sm text-blue-700">
          ...
          <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl p-8 text-white text-center">
            ...
            <p className="text-blue-200 text-sm">
              TimeSaverTools verschijnt nu als icoontje op je beginscherm. Tik erop en je zit meteen in de app &mdash; geen browser, geen zoeken.
            </p>
          </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-10">
          Vragen? Mail naar <a href="mailto:info@timesavertools.nl" className="underline hover:text-gray-600">info@timesavertools.nl</a>
        </p>
      </main>
    </div>
  );
