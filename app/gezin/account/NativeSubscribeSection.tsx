    ...
    return (
      <div className="bg-white border-2 border-amber-300 rounded-2xl p-6 shadow-sm">
        <div className="flex items-center gap-2 mb-1">
          <span>⭐</span>
          <h2 className="font-bold text-gray-900 text-lg">Jaarabonnement</h2>
        </div>
        <p className="text-gray-500 text-sm mb-1">Onbeperkt scannen · opzegbaar wanneer je wil</p>
        <div className="flex items-baseline gap-1 mb-4">
          <span className="text-3xl font-extrabold text-gray-900">€1,49</span>
          <span className="text-gray-400 text-sm">/maand · €17,88/jaar na proefperiode</span>
        </div>
    ...
    <>
      ...
      <div className="bg-white border-2 border-amber-300 rounded-2xl p-6 shadow-sm">
        ...
        <div className="flex items-center justify-between">
          <div>
            <span className="text-3xl font-extrabold text-gray-900">€1,49</span>
            <span className="text-gray-400 text-sm ml-1">/maand · €17,88/jaar na proefperiode</span>
          </div>
